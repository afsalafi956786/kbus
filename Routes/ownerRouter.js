...
import { ownerStartBus,addBusDetails,addRootes,getOneBusdetails,getOwnerbuses,getRooteParticularBus}  from '../controller/owner/bus.js'
...
router.get('/get-root/:busId',verifyToken,getRooteParticularBus)
